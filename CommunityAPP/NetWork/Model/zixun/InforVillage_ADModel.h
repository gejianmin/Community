...
@interface Village_ADModel : NSObject
...
@end
@interface InforVillage_ADModel : RequestBaseModel
@property (nonatomic, copy) NSArray <Village_ADModel *> *Village_ADArray;
