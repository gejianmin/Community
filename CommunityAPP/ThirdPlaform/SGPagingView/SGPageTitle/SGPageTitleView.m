...
- (void)setupTitleButtons {
    ...
    BOOL controlOffSet = YES;
    
//    if (_offSetAnimated == NO) {
//        controlOffSet = YES;
//    }else{
//    }
    ...
    if (!controlOffSet) { /// SGPageTitleView 不可滚动
        CGFloat btnY = 0;
...
//            btn.backgroundColor = [UIColor colorWithRed:60*index/255.0 green:60*index/255.0 blue:60*index/255.0 alpha:1.0];
