...
- (void)reloadDataWithModel:(DWQGoodsModel*)model {
    ...
    self.dateLabel.text = model.total;
    self.numberLabel.text = [NSString stringWithFormat:@"x%ld",(long)model.count];
    self.sizeLabel.text = model.shopName;
...
-(void)setupMainView {
    ...
    bgView.frame = CGRectMake(0, 10, DWQSCREEN_WIDTH - 0, dwq_CartRowHeight - 10);
    ...
    UIView * lineView = [[UIView alloc]initWithFrame:CGRectZero color:kColorGray9];
    ...
    nameLabel.frame = CGRectMake(imageBgView.right + 10, 10, bgView.right-10, 25);
...
//    numberLabel.frame = CGRectMake(bgView.left - 30, addBtn.top, 30, 25);
