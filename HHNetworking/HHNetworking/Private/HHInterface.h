...
@end
//ICClientSession
@interface ICClientSession : HHBaseSession <ICClientSession>
@end
@interface HHAuthSession : HHBaseSession <HHAuthSession>
@end
@interface CRMHomeSession : HHBaseSession <CRMHomeSession>
@end
@interface CRMWorkSession : HHBaseSession <CRMWorkSession>
@end
@interface CRMTececonfereceSession: HHBaseSession <CRMTececonfereceSession>
@end

@interface CRMMineInfoSession : HHBaseSession <CRMMineInfoSession>
@end
