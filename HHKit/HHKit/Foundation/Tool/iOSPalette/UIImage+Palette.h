...
/** demo
 [[UIImage imageNamed:item.imageName] getPaletteImageColor:^(PaletteColorModel *recommendColor, NSDictionary *allModeColorDic, NSError *error) {
    cell.backgroundColor = [UIColor colorFromHexString:recommendColor.imageColorString];
 }];
 */
