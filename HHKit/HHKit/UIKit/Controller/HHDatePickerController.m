...
- (UIView *)containerView{
    if (_containerView==nil) {
        ...
        _containerView.layer.shadowColor = [UIColor blackColor].CGColor;//shadowColor阴影颜色
        _containerView.layer.shadowOffset = CGSizeMake(0,-5);//shadowOffset阴影偏移,x向右偏移4，y向下偏移4，默认(0, -3)
        _containerView.layer.shadowOpacity = 0.4;//阴影透明度，默认0
        _containerView.layer.shadowRadius = 4;//阴影半径，默认3
    }
...
- (void)setupNormalDatePicker{
    ...
    toolBar.items[2].tintColor = [UIColor redColor];
