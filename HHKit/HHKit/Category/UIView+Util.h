...
#pragma mark -- UITextField + Util
typedef NS_ENUM(NSUInteger, UITextFieldVertifyType) {
    UITextFieldVertifyTypeDefault = 0,
    UITextFieldVertifyTypeOnlyWordAndNumber,
};
...
@property (nonatomic, assign) UITextFieldVertifyType vertifyType;

-(void)showToolBar;
@end


#pragma mark -- UITextView + Util
